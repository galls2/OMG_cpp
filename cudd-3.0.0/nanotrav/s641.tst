...
Number of cache look-ups: 101672
Number of cache hits: 38966
Number of cache insertions: 64671
Number of cache collisions: 10659
Number of cache deletions: 40090
Cache used slots = 21.24% (expected 21.35%)
Soft limit for cache size: 225280
Number of buckets in unique table: 56320
Used buckets in unique table: 6.70% (expected 6.75%)
...
Total number of nodes reclaimed: 10551
...
Maximum resident size            =  6864K

Virtual memory limit             = unlimited (unlimited)
Major page faults = 0
Minor page faults = 1662
Swaps = 0
Input blocks = 24
Output blocks = 88
Context switch (voluntary) = 1
Context switch (involuntary) = 26
