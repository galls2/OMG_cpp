...
Maximum resident size            =  5996K

Virtual memory limit             = unlimited (unlimited)
Major page faults = 0
Minor page faults = 1529
Swaps = 0
Input blocks = 16
Output blocks = 16
Context switch (voluntary) = 1
Context switch (involuntary) = 35
