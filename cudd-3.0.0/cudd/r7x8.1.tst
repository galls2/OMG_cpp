...
Number of cache collisions: 734
Number of cache deletions: 1263
Cache used slots = 61.87% (expected 62.36%)
...
Maximum resident size            =  4844K

Virtual memory limit             = unlimited (unlimited)
Major page faults = 3
Minor page faults = 641
Swaps = 0
Input blocks = 584
Output blocks = 16
